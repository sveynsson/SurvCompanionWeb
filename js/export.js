...
const ExportService = (() => {
  ...
  function _generateQgisCsv(points, projektNummer) {
    const header = [
      ...
      'ps1_vermarkungsart','ps1_vermarkungstraeger','ps1_andere_vermarkungsart','ps1_andere_vermarkungstraeger',
    ...
    for (const p of points) {
      const row = [
        ...
        _dn(Models.PS1Vermarkungsart, p.ps1Vermarkungsart),
        _dn(Models.PS1Vermarkungstraeger, p.ps1Vermarkungstraeger),
        p.ps1AndereVermarkungsart ?? '', p.ps1AndereVermarkungstraeger ?? '',
  ...
  function _buildGeoJsonProperties(p, projektNummer, fotoPfade) {
    return {
      ...
      ps1Vermarkungsart: _dn(Models.PS1Vermarkungsart, p.ps1Vermarkungsart),
      ps1Vermarkungstraeger: _dn(Models.PS1Vermarkungstraeger, p.ps1Vermarkungstraeger),
      ps1AndereVermarkungsart: p.ps1AndereVermarkungsart,
